...
namespace AutoEvent.Commands
{
    ...
    public class DeathPartyCommand : ICommand
    {
        public string Command => "ev_death";
        public string[] Aliases => new string[] { };
        public string Description => "Создать авто-ивент Смертельная вечеринка: ev_death";
